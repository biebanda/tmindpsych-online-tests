  ...
  async function saveQuiz() {
    ...
    if (selectedQuiz) {
      ...
      try {
        ...
        if (!res.ok) {
          throw new Error('Failed to update test or quiz');
        }

        toast.success('The test or quiz has been saved successfully.');
    ...
    <div className="poppins my-12 flex justify-between items-center ">
      <div className="flex gap-2 items-center">
        ...
        <span className="text-2xl">
           TM-INDPSYCH -Online Test or Quiz <span className="text-green-700 font-bold">Builder</span>
        </span>
      </div>
      <button
        onClick={() => {
